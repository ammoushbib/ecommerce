        ...
        <tbody id="resultat-diporama"> 
          ...
          foreach($liste as $data )
          {
           ...
           <tr>
            ...
            <td><?php echo $data->_datecmd; ?></td>
            <td>
              <a class="btn btn-primary" href="commande_details.php?id=<?php echo $data->_id; ?>">
            ...
            <td>
             <a href="javascript:confirmDelete('categorie_supp_action.php?id=<?php echo $data->_id; ?>')" class="btn btn-danger btn-mini">
               <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> IMPRIMER
             </a>                 
           </td>
         </tr>
         <?php  } ?>
